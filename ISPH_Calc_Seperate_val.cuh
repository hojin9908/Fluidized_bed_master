...
// printf("KERNEL_set_alpha done\n");
// Coupled_Decoupled_check_sph(dev_P1,dev_P1_sph,dev_SP2,dev_SP2_sph,dev_P3,dev_P3_sph,g_idx_in,g_idx_sph_in);
// Coupled_Decoupled_check_dem(dev_P1,dev_P1_dem,dev_SP2,dev_SP2_dem,dev_P3,dev_P3_dem,g_idx_in,g_idx_dem_in);
...
cudaDeviceSynchronize();
CUDA_CHECK(cudaDeviceSynchronize());
// printf("KERNEL_index_particle_to_cell done\n");
// Coupled_Decoupled_check_sph(dev_P1,dev_P1_sph,dev_SP2,dev_SP2_sph,dev_P3,dev_P3_sph,g_idx_in,g_idx_sph_in);
// Coupled_Decoupled_check_dem(dev_P1,dev_P1_dem,dev_SP2,dev_SP2_dem,dev_P3,dev_P3_dem,g_idx_in,g_idx_dem_in);
...
cudaDeviceSynchronize();
CUDA_CHECK(cudaDeviceSynchronize());
// printf("cub::DeviceRadixSort::SortPairs done\n");
// Coupled_Decoupled_check_sph(dev_P1,dev_P1_sph,dev_SP2,dev_SP2_sph,dev_P3,dev_P3_sph,g_idx_in,g_idx_sph_in);
// Coupled_Decoupled_check_dem(dev_P1,dev_P1_dem,dev_SP2,dev_SP2_dem,dev_P3,dev_P3_dem,g_idx_in,g_idx_dem_in);
...
cudaDeviceSynchronize();
CUDA_CHECK(cudaDeviceSynchronize());
// printf("KERNEL_reorder done\n");
// Coupled_Decoupled_check_sph(dev_SP1,dev_SP1_sph,dev_SP2,dev_SP2_sph,dev_P3,dev_P3_sph,g_idx,g_idx_sph);
// Coupled_Decoupled_check_dem(dev_SP1,dev_SP1_dem,dev_SP2,dev_SP2_dem,dev_P3,dev_P3_dem,g_idx,g_idx_dem);
...
cudaDeviceSynchronize();
CUDA_CHECK(cudaDeviceSynchronize());
printf("KERNEL_clc_mass_init_sph done\n");
Coupled_Decoupled_check_sph(dev_SP1,dev_SP1_sph,dev_SP2,dev_SP2_sph,dev_P3,dev_P3_sph,g_idx,g_idx_sph);
Coupled_Decoupled_check_dem(dev_SP1,dev_SP1_dem,dev_SP2,dev_SP2_dem,dev_P3,dev_P3_dem,g_idx,g_idx_dem);
...
printf("gradient_correction_sph done\n");
Coupled_Decoupled_check_sph(dev_SP1,dev_SP1_sph,dev_SP2,dev_SP2_sph,dev_P3,dev_P3_sph,g_idx,g_idx_sph);
Coupled_Decoupled_check_dem(dev_SP1,dev_SP1_dem,dev_SP2,dev_SP2_dem,dev_P3,dev_P3_dem,g_idx,g_idx_dem);
...
cudaDeviceSynchronize();
CUDA_CHECK(cudaDeviceSynchronize());
printf("KERNEL_clc_prep3D_coupling done\n");
Coupled_Decoupled_check_sph(dev_SP1,dev_SP1_sph,dev_SP2,dev_SP2_sph,dev_P3,dev_P3_sph,g_idx,g_idx_sph);
Coupled_Decoupled_check_dem(dev_SP1,dev_SP1_dem,dev_SP2,dev_SP2_dem,dev_P3,dev_P3_dem,g_idx,g_idx_dem);
...
cudaDeviceSynchronize();
CUDA_CHECK(cudaDeviceSynchronize());
printf("KERNEL_clc_prep3D_sph done\n");
Coupled_Decoupled_check_sph(dev_SP1,dev_SP1_sph,dev_SP2,dev_SP2_sph,dev_P3,dev_P3_sph,g_idx,g_idx_sph);
Coupled_Decoupled_check_dem(dev_SP1,dev_SP1_dem,dev_SP2,dev_SP2_dem,dev_P3,dev_P3_dem,g_idx,g_idx_dem);
...
cudaDeviceSynchronize();
CUDA_CHECK(cudaDeviceSynchronize());
printf("KERNEL_advection_force3D done\n");
Coupled_Decoupled_check_sph(dev_SP1,dev_SP1_sph,dev_SP2,dev_SP2_sph,dev_P3,dev_P3_sph,g_idx,g_idx_sph);
Coupled_Decoupled_check_dem(dev_SP1,dev_SP1_dem,dev_SP2,dev_SP2_dem,dev_P3,dev_P3_dem,g_idx,g_idx_dem);
...
cudaDeviceSynchronize();
CUDA_CHECK(cudaDeviceSynchronize());
printf("KERNEL_DEM_interaction3D done\n");
Coupled_Decoupled_check_sph(dev_SP1,dev_SP1_sph,dev_SP2,dev_SP2_sph,dev_P3,dev_P3_sph,g_idx,g_idx_sph);
Coupled_Decoupled_check_dem(dev_SP1,dev_SP1_dem,dev_SP2,dev_SP2_dem,dev_P3,dev_P3_dem,g_idx,g_idx_dem);
...
cudaDeviceSynchronize();
CUDA_CHECK(cudaDeviceSynchronize());
printf("KERNEL_DEM_coupling3D done\n");
Coupled_Decoupled_check_sph(dev_SP1,dev_SP1_sph,dev_SP2,dev_SP2_sph,dev_P3,dev_P3_sph,g_idx,g_idx_sph);
Coupled_Decoupled_check_dem(dev_SP1,dev_SP1_dem,dev_SP2,dev_SP2_dem,dev_P3,dev_P3_dem,g_idx,g_idx_dem);
...
cudaDeviceSynchronize();
CUDA_CHECK(cudaDeviceSynchronize());
printf("KERNEL_SPH_coupling3D done\n");
Coupled_Decoupled_check_sph(dev_SP1,dev_SP1_sph,dev_SP2,dev_SP2_sph,dev_P3,dev_P3_sph,g_idx,g_idx_sph);
Coupled_Decoupled_check_dem(dev_SP1,dev_SP1_dem,dev_SP2,dev_SP2_dem,dev_P3,dev_P3_dem,g_idx,g_idx_dem);
...
cudaDeviceSynchronize();
CUDA_CHECK(cudaDeviceSynchronize());
printf("KERNEL_clc_projection done\n");
Coupled_Decoupled_check_sph(dev_SP1,dev_SP1_sph,dev_SP2,dev_SP2_sph,dev_P3,dev_P3_sph,g_idx,g_idx_sph);
Coupled_Decoupled_check_dem(dev_SP1,dev_SP1_dem,dev_SP2,dev_SP2_dem,dev_P3,dev_P3_dem,g_idx,g_idx_dem);
...
// cudaDeviceSynchronize();
// if(dim==2) KERNEL_clc_invA_MLS_2D<<<b,t>>>(g_str,g_end,dev_SP1,dev_P3);
// cudaDeviceSynchronize();
...
// if(dim==3)	KERNEL_clc_surface_detect3D<<<b,t>>>(g_str,g_end,dev_SP1,dev_P3);
// cudaDeviceSynchronize();
...
cudaDeviceSynchronize();
CUDA_CHECK(cudaDeviceSynchronize());
printf("KERNEL_Neumann_boundary3D done\n");
Coupled_Decoupled_check_sph(dev_SP1,dev_SP1_sph,dev_SP2,dev_SP2_sph,dev_P3,dev_P3_sph,g_idx,g_idx_sph);
Coupled_Decoupled_check_dem(dev_SP1,dev_SP1_dem,dev_SP2,dev_SP2_dem,dev_P3,dev_P3_dem,g_idx,g_idx_dem);
...
cudaDeviceSynchronize();
CUDA_CHECK(cudaDeviceSynchronize());
printf("KERNEL_pressureforce3D done\n");
Coupled_Decoupled_check_sph(dev_SP1,dev_SP1_sph,dev_SP2,dev_SP2_sph,dev_P3,dev_P3_sph,g_idx,g_idx_sph);
Coupled_Decoupled_check_dem(dev_SP1,dev_SP1_dem,dev_SP2,dev_SP2_dem,dev_P3,dev_P3_dem,g_idx,g_idx_dem);
...
cudaDeviceSynchronize();
CUDA_CHECK(cudaDeviceSynchronize());
printf("KERNEL_time_update_projection done\n");
Coupled_Decoupled_check_sph(dev_P1,dev_P1_sph,dev_P2,dev_P2_sph,dev_P3,dev_P3_sph,g_idx,g_idx_sph);
Coupled_Decoupled_check_dem(dev_P1,dev_P1_dem,dev_P2,dev_P2_dem,dev_P3,dev_P3_dem,g_idx,g_idx_dem);


// KERNEL_vorticity_2D<<<b,t>>>(g_str,g_end,dev_P1,dev_P3);
// cudaDeviceSynchronize();
...
if(open_boundary>0)
{
	...
	if((count%decouple_stride)==0){
		b.x=(num_part2_sph-1)/t.x+1;
		KERNEL_open_boundary_extrapolation3D_1_sph<<<b,t>>>(time, g_str_sph,g_end_sph,dev_P1_sph,dev_SP2_sph,dev_P3_sph,count,dt);
	}
    cudaDeviceSynchronize();
	CUDA_CHECK(cudaDeviceSynchronize());
	...
	if((count%decouple_stride)==0){
		b.x=(num_part2_sph-1)/t.x+1;
		KERNEL_open_boundary_extrapolation3D_1_calc_sph<<<b,t>>>(time, g_str_sph,g_end_sph,dev_P1_sph,dev_SP2_sph,dev_P3_sph,count,dt);
	}
    cudaDeviceSynchronize();
	CUDA_CHECK(cudaDeviceSynchronize());
}
cudaDeviceSynchronize();
CUDA_CHECK(cudaDeviceSynchronize());
printf("KERNEL_open_boundary_extrapolation3D_1 done\n");
Coupled_Decoupled_check_sph(dev_P1,dev_P1_sph,dev_SP2,dev_SP2_sph,dev_P3,dev_P3_sph,g_idx,g_idx_sph);
Coupled_Decoupled_check_dem(dev_P1,dev_P1_dem,dev_SP2,dev_SP2_dem,dev_P3,dev_P3_dem,g_idx,g_idx_dem);
...
// KERNEL_treat_DEM_pyramid_z<<<b,t>>>(1,dev_SP1,dev_P1,dev_SP2,dev_P3,time);	
KERNEL_treat_DEM_truncated_cone_z<<<b,t>>>(1,dev_SP1,dev_P1,dev_SP2,dev_P3,time);	
b.x=(num_part2_dem-1)/t.x+1;
KERNEL_treat_DEM_cylinder_z_dem<<<b,t>>>(1,dev_SP1_dem,dev_P1_dem,dev_SP2_dem,dev_P3_dem);
KERNEL_treat_DEM_box_z_dem<<<b,t>>>(1,dev_SP1_dem,dev_P1_dem,dev_SP2_dem,dev_P3_dem,time);
KERNEL_treat_DEM_truncated_cone_z_dem<<<b,t>>>(1,dev_SP1_dem,dev_P1_dem,dev_SP2_dem,dev_P3_dem,time);
cudaDeviceSynchronize();
CUDA_CHECK(cudaDeviceSynchronize());
printf("KERNEL_treat_DEM_truncated_cone_z done\n");
Coupled_Decoupled_check_sph(dev_SP1,dev_SP1_sph,dev_SP2,dev_SP2_sph,dev_P3,dev_P3_sph,g_idx,g_idx_sph);
Coupled_Decoupled_check_dem(dev_SP1,dev_SP1_dem,dev_SP2,dev_SP2_dem,dev_P3,dev_P3_dem,g_idx,g_idx_dem);
...
//-------------------------------------------------------------------------------------------------
// XSPH solve
// xsph를 계산해서 dev_P1.ux에 반영해서 계산해 저장
//-------------------------------------------------------------------------------------------------
...
if(((count%freq_output)==0) ){
		...
		save_plot_fluid_vtk_bin_fluid_sph(file_P1_sph,file_P2_sph,file_P3_sph);
...
void*ISPH_Calc(void*arg){
	...
	c_initial_inner_outer_particle_single_sph(HP1_sph,DHP1_sph[tid],tid);			// (CAUTION)
	c_initial_inner_outer_particle_single_dem(HP1_dem,DHP1_dem[tid],tid);			// (CAUTION)
